...
tasks = Task.create([
  { project_id: war.id, name: "Capture Edmure Tully", due: DateTime.new(2017, 1, 21), creator_id: tywin.id, assignee_id: jaime.id, order: 0},
  { project_id: war.id, name: "Hold the River Crossing", due: DateTime.new(2017, 1, 22), creator_id: tywin.id, assignee_id: jaime.id, order: 1},
  { project_id: war.id, name: "Skin a Deer", creator_id: tywin.id, assignee_id: tywin.id, order: 2},
  { project_id: war.id, name: "Monitor Baratheon Forces", creator_id: tywin.id, order: 3},
  { project_id: secure.id, name: "Find Joffrey a Suitable Queen", due: DateTime.new(2017, 1, 29), creator_id: tywin.id, assignee_id: cersei.id, order: 0},
  { project_id: secure.id, name: "Mentor Joffrey", creator_id: tywin.id, assignee_id: tywin.id, order: 1},
  { project_id: secure.id, name: "Marry Loras Tyrell", due: DateTime.new(2017, 2, 28), creator_id: tywin.id, assignee_id: cersei.id, order: 2},
  { project_id: secure.id, name: "Write Letters", creator_id: tywin.id, assignee_id: tywin.id, order: 3},
  { project_id: secure.id, name: "Sit at Desk", creator_id: tywin.id, assignee_id: tywin.id, order: 4},
  { project_id: secure.id, name: "Pander to Common People", creator_id: tywin.id, order: 5},
  { project_id: tourney.id, name: "Secure Funding", creator_id: guest.id, assignee_id: littlefinger.id, order: 0},
  { project_id: tourney.id, name: "Cost-Benefit Analysis", creator_id: guest.id, order: 1},
  { project_id: tourney.id, name: "Win the Melee", due: DateTime.new(2017, 2, 14), creator_id: jaime.id, assignee_id: jaime.id, order: 2},
  { project_id: tourney.id, name: "Oversee Construction", creator_id: guest.id, assignee_id: cersei.id, order: 3},
  { project_id: tourney.id, name: "Do Varys Things", creator_id: guest.id, assignee_id: varys.id, order: 4},
  { project_id: wedding.id, name: "Set Budget", creator_id: guest.id, order: 0},
  { project_id: wedding.id, name: "Oversee Design", creator_id: guest.id, assignee_id: cersei.id, order: 1},
  { project_id: wedding.id, name: "Negotiate Terms", due: DateTime.new(2017, 1, 25), creator_id: guest.id, assignee_id: tywin.id, order: 2},
  { project_id: wedding.id, name: "Drink Wine", creator_id: guest.id, assignee_id: guest.id, order: 3},
  { project_id: wedding.id, name: "Do Varys Things", creator_id: guest.id, assignee_id: varys.id, order: 4},
  { project_id: siege.id, name: "Design Battle Plan", creator_id: guest.id, assignee_id: guest.id, order: 0},
  { project_id: siege.id, name: "Rally Troops", due: DateTime.new(2017, 2, 2), creator_id: guest.id, assignee_id: guest.id, order: 1},
  { project_id: siege.id, name: "Intimidate Sansa", due: DateTime.new(2017, 2, 2), creator_id: guest.id, assignee_id: cersei.id, order: 2},
  { project_id: siege.id, name: "Show Up Last Minute", due: DateTime.new(2017, 2, 2), creator_id: guest.id, assignee_id: tywin.id, order: 3},
  { project_id: siege.id, name: "Do Varys Things", creator_id: guest.id, assignee_id: varys.id, order: 4}
])
